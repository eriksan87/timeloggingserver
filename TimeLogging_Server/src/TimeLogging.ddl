...
ALTER TABLE ESpesaExtra ADD INDEX FKESpesaExtr266798 (ESottoprogettoID), ADD CONSTRAINT FKESpesaExtr266798 FOREIGN KEY (ESottoprogettoID) REFERENCES ESottoprogetto (ID);
ALTER TABLE ESpesaExtra ADD INDEX FKESpesaExtr453168 (EProgettoID), ADD CONSTRAINT FKESpesaExtr453168 FOREIGN KEY (EProgettoID) REFERENCES EProgetto (ID);
...
ALTER TABLE ETariffa ADD INDEX FKETariffa204915 (ETaskID), ADD CONSTRAINT FKETariffa204915 FOREIGN KEY (ETaskID) REFERENCES ETask (ID);
ALTER TABLE ETimeRecordLavorativo ADD INDEX FKETimeRecor42889 (ETaskID), ADD CONSTRAINT FKETimeRecor42889 FOREIGN KEY (ETaskID) REFERENCES ETask (ID);
ALTER TABLE ETask ADD INDEX FKETask966144 (ESottoprogettoID), ADD CONSTRAINT FKETask966144 FOREIGN KEY (ESottoprogettoID) REFERENCES ESottoprogetto (ID);
...
ALTER TABLE ESottoprogetto ADD INDEX FKESottoprog698367 (EProgettoID), ADD CONSTRAINT FKESottoprog698367 FOREIGN KEY (EProgettoID) REFERENCES EProgetto (ID);
...
ALTER TABLE EDipendente_ETask ADD INDEX EDipendente_ETask2 (ETaskID), ADD CONSTRAINT EDipendente_ETask2 FOREIGN KEY (ETaskID) REFERENCES ETask (ID);
