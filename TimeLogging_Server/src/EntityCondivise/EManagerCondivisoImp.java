...
public class EManagerCondivisoImp extends EManagerCondiviso {

	public EManagerCondivisoImp()
	{
		super();
	}
	public EManagerCondivisoImp(int id, String nome, String cognome, String indirizzo, double pagaBase, String figProfessionale, int anzianita, String tag,String username,String password)
    {
