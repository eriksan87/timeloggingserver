...
public class EAdminCondivisoImp extends EAdminCondiviso {

	public EAdminCondivisoImp()
	{
		super();
	}
	public EAdminCondivisoImp(int id, String nome, String cognome, String indirizzo, double pagaBase, String figProfessionale, int anzianita, String tag,String username,String password)
    {
