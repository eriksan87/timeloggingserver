...
public class TimeLoggingPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "TimeLogging";
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new TimeLoggingPersistentManager();
		}
