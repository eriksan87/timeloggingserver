...
public interface _AttivitaManagerOperationsNC
{
    ...
    java.util.ArrayList<Condivisione.EntityCondivise.ETaskCondiviso> getListTaskConsulente(Condivisione.EntityCondivise.EConsulenteCondiviso consulente);

    java.util.ArrayList<Condivisione.EntityCondivise.ESottoprogettoCondiviso> getListSottoprogettiManager(Condivisione.EntityCondivise.EManagerCondiviso manager);

    java.util.ArrayList<Condivisione.EntityCondivise.ETaskCondiviso> getAllTask();

    java.util.ArrayList<Condivisione.EntityCondivise.ESottoprogettoCondiviso> getAllSp(Condivisione.EntityCondivise.EManagerCondiviso manager);

    void eliminaAttivita(Condivisione.EntityCondivise.EAttivitaCondivisa attivita);

    java.util.ArrayList<Condivisione.EntityCondivise.EProgettoCondiviso> getListProgettiClienti(Condivisione.EntityCondivise.EClienteCondiviso cliente);
}
