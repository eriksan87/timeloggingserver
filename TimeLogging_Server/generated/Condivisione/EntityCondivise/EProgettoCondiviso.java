                                                    ...
                                                    _EProgettoCondivisoOperationsNC
{
    ...
    public final double elaboraFattura()
    {
        return elaboraFattura(null);
    }

    public final double elaboraGuadagno()
    {
        return elaboraGuadagno(null);
    }
    ...
    public static Ice.DispatchStatus ___elaboraGuadagno(EProgettoCondiviso __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.readEmptyParams();
        double __ret = __obj.elaboraGuadagno(__current);
        IceInternal.BasicStream __os = __inS.__startWriteParams(Ice.FormatType.DefaultFormat);
    ...
    public static Ice.DispatchStatus ___elaboraFattura(EProgettoCondiviso __obj, IceInternal.Incoming __inS, Ice.Current __current)
    {
        __checkMode(Ice.OperationMode.Normal, __current.mode);
        __inS.readEmptyParams();
        double __ret = __obj.elaboraFattura(__current);
        IceInternal.BasicStream __os = __inS.__startWriteParams(Ice.FormatType.DefaultFormat);
        __os.writeDouble(__ret);
        __inS.__endWriteParams(true);
        return Ice.DispatchStatus.DispatchOK;
    ...
    public Ice.DispatchStatus __dispatch(IceInternal.Incoming in, Ice.Current __current)
    {
        ...
        switch(pos)
        {
            ...
            case 2:
            {
                return ___elaboraFattura(this, in, __current);
            }
            case 3:
            {
                return ___elaboraGuadagno(this, in, __current);
            }
            case 4:
            {
    ...
    public static final long serialVersionUID = -122113562L;
}
