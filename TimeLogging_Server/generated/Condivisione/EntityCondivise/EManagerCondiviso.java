...
public abstract class EManagerCondiviso extends EDipendenteCondiviso
                                        implements _EManagerCondivisoOperations,
                                                   _EManagerCondivisoOperationsNC
{
    public EManagerCondiviso()
    {
        super();
    }

    public EManagerCondiviso(int id, String nome, String cognome, String indirizzo, double pagaBase, String figProfessionale, int anzianita, String username, String password)
    {
    ...
    public static final long serialVersionUID = 1062308966L;
}
