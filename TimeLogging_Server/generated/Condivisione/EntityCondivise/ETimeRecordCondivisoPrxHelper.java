...
public final class ETimeRecordCondivisoPrxHelper extends Ice.ObjectPrxHelperBase implements ETimeRecordCondivisoPrx
{
        ...
        try
        {
            while(true)
            {
                ...
                try
                {
                    ...
                    _ETimeRecordCondivisoDel __del = (_ETimeRecordCondivisoDel)__delBase;
    ...
    public static ETimeRecordCondivisoPrx checkedCast(Ice.ObjectPrx __obj)
    {
        ETimeRecordCondivisoPrx __d = null;
        if(__obj != null)
        {
            if(__obj instanceof ETimeRecordCondivisoPrx)
            {
                __d = (ETimeRecordCondivisoPrx)__obj;
            }
            else
            {
                if(__obj.ice_isA(ice_staticId()))
                {
                    ETimeRecordCondivisoPrxHelper __h = new ETimeRecordCondivisoPrxHelper();
    ...
    public static ETimeRecordCondivisoPrx checkedCast(Ice.ObjectPrx __obj, java.util.Map<String, String> __ctx)
    {
        ETimeRecordCondivisoPrx __d = null;
        if(__obj != null)
        {
    ...
    public static ETimeRecordCondivisoPrx checkedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ETimeRecordCondivisoPrx __d = null;
        if(__obj != null)
        {
    ...
    public static ETimeRecordCondivisoPrx checkedCast(Ice.ObjectPrx __obj, String __facet, java.util.Map<String, String> __ctx)
    {
        ETimeRecordCondivisoPrx __d = null;
        if(__obj != null)
        {
    ...
    public static ETimeRecordCondivisoPrx uncheckedCast(Ice.ObjectPrx __obj)
    {
        ETimeRecordCondivisoPrx __d = null;
        if(__obj != null)
        {
    ...
    public static ETimeRecordCondivisoPrx uncheckedCast(Ice.ObjectPrx __obj, String __facet)
    {
        ETimeRecordCondivisoPrx __d = null;
        if(__obj != null)
        {
    ...
    {
        return new _ETimeRecordCondivisoDelM();
    }

    protected Ice._ObjectDelD __createDelegateD()
    {
        return new _ETimeRecordCondivisoDelD();
    }

    public static void __write(IceInternal.BasicStream __os, ETimeRecordCondivisoPrx v)
    {
        __os.writeProxy(v);
    }

    public static ETimeRecordCondivisoPrx __read(IceInternal.BasicStream __is)
    {
        Ice.ObjectPrx proxy = __is.readProxy();
        if(proxy != null)
        {
            ETimeRecordCondivisoPrxHelper result = new ETimeRecordCondivisoPrxHelper();
