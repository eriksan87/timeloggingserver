...
public final class _ETimeRecordNonLavorativoCondivisoDelM extends Ice._ObjectDelM implements _ETimeRecordNonLavorativoCondivisoDel
{
    public String
    ...
    public String
    getCategoria(java.util.Map<String, String> __ctx, Ice.Instrumentation.InvocationObserver __observer)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("getCategoria", Ice.OperationMode.Normal, __ctx, __observer);
        try
        {
            __og.writeEmptyParams();
            boolean __ok = __og.invoke();
    ...
    public void
    setCategoria(String categoria, java.util.Map<String, String> __ctx, Ice.Instrumentation.InvocationObserver __observer)
        throws IceInternal.LocalExceptionWrapper
    {
        IceInternal.Outgoing __og = __handler.getOutgoing("setCategoria", Ice.OperationMode.Normal, __ctx, __observer);
        try
        {
            try
            {
