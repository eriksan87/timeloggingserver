...
public final class EProgettoCondivisoPrxHelper extends Ice.ObjectPrxHelperBase implements EProgettoCondivisoPrx
{
    ...
    private static final String __elaboraFattura_name = "elaboraFattura";

    public double elaboraFattura()
    {
        return elaboraFattura(null, false);
    }

    public double elaboraFattura(java.util.Map<String, String> __ctx)
    {
        return elaboraFattura(__ctx, true);
    }

    private double elaboraFattura(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        }
        final Ice.Instrumentation.InvocationObserver __observer = IceInternal.ObserverHelper.get(this, "elaboraFattura", __ctx);
        int __cnt = 0;
        try
        {
            while(true)
            {
                ...
                try
                {
                    __checkTwowayOnly("elaboraFattura");
                    __delBase = __getDelegate(false);
                    _EProgettoCondivisoDel __del = (_EProgettoCondivisoDel)__delBase;
                    return __del.elaboraFattura(__ctx, __observer);
                }
                catch(IceInternal.LocalExceptionWrapper __ex)
                {
                    __handleExceptionWrapper(__delBase, __ex, __observer);
    ...
    private Ice.AsyncResult begin_elaboraFattura(java.util.Map<String, String> __ctx, boolean __explicitCtx, IceInternal.CallbackBase __cb)
    {
        __checkAsyncTwowayOnly(__elaboraFattura_name);
        IceInternal.OutgoingAsync __result = new IceInternal.OutgoingAsync(this, __elaboraFattura_name, __cb);
        try
        {
            __result.__prepare(__elaboraFattura_name, Ice.OperationMode.Normal, __ctx, __explicitCtx);
            __result.__writeEmptyParams();
            __result.__send(true);
        }
        catch(Ice.LocalException __ex)
    ...
    {
        Ice.AsyncResult.__check(__result, this, __elaboraFattura_name);
        boolean __ok = __result.__wait();
        try
        {
            if(!__ok)
    ...
    private static final String __elaboraGuadagno_name = "elaboraGuadagno";

    public double elaboraGuadagno()
    {
        return elaboraGuadagno(null, false);
    }

    public double elaboraGuadagno(java.util.Map<String, String> __ctx)
    {
        return elaboraGuadagno(__ctx, true);
    }

    private double elaboraGuadagno(java.util.Map<String, String> __ctx, boolean __explicitCtx)
    {
        if(__explicitCtx && __ctx == null)
        {
            __ctx = _emptyContext;
        }
        final Ice.Instrumentation.InvocationObserver __observer = IceInternal.ObserverHelper.get(this, "elaboraGuadagno", __ctx);
        int __cnt = 0;
        try
        {
            while(true)
            {
                ...
                try
                {
                    __checkTwowayOnly("elaboraGuadagno");
                    __delBase = __getDelegate(false);
                    _EProgettoCondivisoDel __del = (_EProgettoCondivisoDel)__delBase;
                    return __del.elaboraGuadagno(__ctx, __observer);
                }
                catch(IceInternal.LocalExceptionWrapper __ex)
                {
                    __handleExceptionWrapper(__delBase, __ex, __observer);
    ...
    private Ice.AsyncResult begin_elaboraGuadagno(java.util.Map<String, String> __ctx, boolean __explicitCtx, IceInternal.CallbackBase __cb)
    {
        __checkAsyncTwowayOnly(__elaboraGuadagno_name);
        IceInternal.OutgoingAsync __result = new IceInternal.OutgoingAsync(this, __elaboraGuadagno_name, __cb);
        try
        {
            __result.__prepare(__elaboraGuadagno_name, Ice.OperationMode.Normal, __ctx, __explicitCtx);
            __result.__writeEmptyParams();
            __result.__send(true);
        }
        catch(Ice.LocalException __ex)
    ...
    {
        Ice.AsyncResult.__check(__result, this, __elaboraGuadagno_name);
        boolean __ok = __result.__wait();
        try
        {
            if(!__ok)
